                ...
                <div class="tab-pane fade active show" id="app-settings" role="tabpanel">
                    ...
                    <div class="p-2">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="float-right"><label class="switch"><input id="chk-rtl" type="checkbox" checked><span></span></label></div>
                        </div>
                    </div>
                    <div class="p-2">
                ...
                <div class="tab-pane fade" id="app-chat" role="tabpanel">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/05.jpg') }}" alt="Image">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/06.jpg') }}" alt="Image">
                                <div class="media-body text-truncate"><a href="#"><strong>Maureen Jenkins</strong></a><br><small class="text-muted">Designeer</small></div>
                                <div class="ml-auto"><span class="circle bg-success circle-lg"></span></div>
                            </div>
                        </div>
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/07.jpg') }}" alt="Image">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/08.jpg') }}" alt="Image">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/09.jpg') }}" alt="Image">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media"><img class="align-self-center mr-3 rounded-circle thumb48" src="{{ asset('angle/img/user/10.jpg') }}" alt="Image">
