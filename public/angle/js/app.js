...
(function() {
    ...
    var pathPrefix = 'angle/server/i18n'; // folder of json files
...
(function() {
    ...
    function initRTL() {
        ...
        $('#chk-rtl').on('change', function() {
            // app rtl check
            maincss.attr('href', this.checked ? '../angle/css/app-rtl.css' : '../angle/css/app.css');
            // bootstrap rtl check
            bscss.attr('href', this.checked ? '../angle/css/bootstrap-rtl.css' : '../angle/css/bootstrap.css');
        });
    }
